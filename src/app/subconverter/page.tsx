...
export default function SubConverter() {
  ...
  const convertSubscription = async () => {
    ...
    try {
      const requestUrl = `https://subconverter.skiuo.com/sub?target=clash&url=${processedUrl}&config=ACL4SSR_Clash_Meta.ini&udp=true&emoji=false&flag=meta&list=true`
